...
namespace BigAmbitionsMP
{
    ...
    public class SharedWorkInfoPayload
    {
        ...
        public string                 AckCode   { get; set; } = "";       // wave 4 r2 (minor f): Tab "mergerack" — a short CODE for a routed refusal ("dupe" / "shelf"), never a text: the member maps it to the game's OWN notification key locally, so nothing on the wire can put words on a screen
    }
